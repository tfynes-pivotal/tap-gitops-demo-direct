...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-demo-direct
echo     https://github.com/tfynes-pivotal/tap-gitops-demo-direct
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-demo-direct --public
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-demo-direct
git branch -M main
